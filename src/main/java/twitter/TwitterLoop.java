...
public class TwitterLoop {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TwitterLoop taskObj = new TwitterLoop();
	...
	public void getTweetByQuery(boolean loadRecords, String keyword)
		...
		if (cb != null) {
			...
			System.out
					.println("MongoDB is not Connected! Please check mongoDB intance running..");
		}
	}

	public void getTweetsRecords() throws InterruptedException {
		BasicDBObject fields = new BasicDBObject("_id", true).append(
